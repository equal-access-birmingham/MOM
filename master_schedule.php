...
require_once($path_to_root . "includes/header_require-admin.php");
?>
...
{
	echo "            <p>All selected times could not be deleted, please contact the EAB IT Team for assistance.</p>\n";
}
?>
          </div>
          <div class="modal-footer">
