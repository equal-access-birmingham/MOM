...
-- ------------------------------------------------------
-- Server version	10.0.13-MariaDB-1~trusty-log
...
INSERT INTO `arrival_time_table` VALUES (48,1,1,'13:30:00'),(49,1,2,'16:30:00'),(50,2,1,'13:00:00'),(51,3,1,'12:30:00'),(52,4,1,'12:30:00'),(53,4,2,'15:30:00'),(54,5,1,'12:30:00'),(55,6,1,'12:00:00'),(56,7,1,'12:30:00'),(57,8,1,'12:30:00'),(58,9,1,'12:30:00'),(59,12,1,'12:30:00'),(60,13,2,'15:00:00'),(61,14,2,'15:30:00'),(62,15,1,'13:00:00'),(63,15,2,'16:00:00'),(64,18,1,'13:00:00'),(65,19,1,'12:30:00'),(66,23,1,'12:30:00'),(67,23,2,'15:30:00');
...
INSERT INTO `location_table` VALUES (1,'Church of the Reconciler','112 14th St N, Birmingham, AL (Church of the Reconciler)'),(2,'M-Power Ministries','4022 4th Ave S, Birmingham, AL'),(3,'Screening locations',NULL);
...
CREATE TABLE `login_relation_table` (
  ...
  KEY `FK_login_relation_user_id` (`user_id`),
  ...
  CONSTRAINT `FK_login_relation_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `login_relation_table` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4);
...
INSERT INTO `person_table` VALUES (1,'bob','','anders','',2,'0000-00-00','(123) 456-7890'),(2,'Tim','','Kennell','',2,'0000-00-00','(123) 456-7890'),(3,'Nico','','Herrera','',2,'0000-00-00','(123) 456-7890'),(4,'Jill','','Felicita','',1,'0000-00-00','(123) 456-7890');
...
CREATE TABLE `person_training_relation_table` (
  ...
  CONSTRAINT `FK_person_training_relation_table` FOREIGN KEY (`login_relation_id`) REFERENCES `login_relation_table` (`login_relation_id`),
...
INSERT INTO `person_training_relation_table` VALUES (1,1,1),(2,1,2),(3,1,3),(4,2,1),(5,3,1),(6,3,3),(7,4,1),(8,4,2);
...
INSERT INTO `position_relation_table` VALUES (1,1,1),(2,2,2),(3,3,1),(4,4,2);
...
INSERT INTO `program_relation_table` VALUES (1,1,1,'2015-11-12','13:00:00','18:00:00'),(2,1,1,'2015-09-17','13:00:00','18:00:00'),(3,2,2,'2015-03-18','15:30:00','19:00:00'),(4,2,2,'2014-05-21','15:30:00','19:00:00');
...
CREATE TABLE `program_table` (
  ...
  CONSTRAINT `FK_program_table_program_type_id` FOREIGN KEY (`program_type_id`) REFERENCES `program_type_table` (`program_type_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `school_relation_table` (
  `school_relation_id` bigint(20) NOT NULL,
  `login_relation_id` bigint(20) NOT NULL COMMENT 'References the login_relation_id in the `login_relation_table`',
...
INSERT INTO `school_relation_table` VALUES (2,1,1,2),(3,2,1,4),(4,3,2,12),(5,4,4,20);
...
CREATE TABLE `signup_table` (
  ...
  CONSTRAINT `FK_signup_table_program_relation_id` FOREIGN KEY (`program_relation_id`) REFERENCES `program_relation_table` (`program_relation_id`),
...
INSERT INTO `signup_table` VALUES (1,1,1,3),(2,1,1,3),(3,2,2,14),(4,3,2,14);
...
INSERT INTO `users` VALUES (1,'banders','$2y$10$LkliNBfbVsHpEaby3QapJOcXIiLgtKeZpwFXLFVAmYMnJhcfhp.Z2','banders@example.com',1,NULL,NULL,NULL,NULL,0,NULL,'0000-00-00 00:00:00','0.0.0.0',0),(2,'tikenn','$2y$10$LkliNBfbVsHpEaby3QapJOcXIiLgtKeZpwFXLFVAmYMnJhcfhp.Z2','tikenn@example.com',1,NULL,NULL,NULL,NULL,0,NULL,'0000-00-00 00:00:00','0.0.0.0',0),(3,'nherrera','$2y$10$LkliNBfbVsHpEaby3QapJOcXIiLgtKeZpwFXLFVAmYMnJhcfhp.Z2','nherrera@example.com',1,NULL,NULL,NULL,NULL,0,NULL,'0000-00-00 00:00:00','0.0.0.0',0),(4,'jfelic','$2y$10$LkliNBfbVsHpEaby3QapJOcXIiLgtKeZpwFXLFVAmYMnJhcfhp.Z2','jfelic@example.com',1,NULL,NULL,NULL,NULL,0,NULL,'0000-00-00 00:00:00','0.0.0.0',0);
...
-- Dump completed on 2014-11-08 19:27:53
